...
# I want to iterate each  element of the list and add 2 to each element of the list

# Convert list to rdd
rddnumlist = sc.parallelize(numlist)
print("===================RDD===================")
print(rddnumlist.collect())
print()

# Use lambda with operation
addrdd = rddnumlist.map(lambda x:x+2)
print("===================ADDRDD===================")
print(addrdd.collect())
print()

# To iterate each element of the list and multiply 10
mulrdd=rddnumlist.map(lambda x:x*10)
print("===================MULRDD===================")
print(mulrdd.collect())
print()

# To filter elements greater than 2
filrdd=rddnumlist.filter(lambda x:x>2)
print("===================FILRDD===================")
