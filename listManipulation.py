...
# Expected output -- need 2 lists
#  ["TN", "Kerala"]
# ["Chennai", "Trivandrum"]

#  1. Flatten the rdd list
flatd = rddls.flatMap(lambda x:x.split("~"))
...
#  2. Filter the flattened list into state and city
...
# 3. Replace the State -> and City -> with empty
