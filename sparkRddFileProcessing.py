...
# Filename = usdata.cvs
# Iterate each row of the usdata.csv and filter row length greater than 200
# From filtered row, flatten row with "," split.
# From flattened rows, replace - with empty
# Concatenate with ,zeyo
# Write the results in D drive
...
# Concatenate with ,zeyo
concatdata = repdata.map(lambda x: x+ ", zeyo")
print()
print("=====================concatdata=======================")
